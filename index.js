...
const TOKEN = config.logistuzbot.token

const bot = new TelegramBot(TOKEN,{
	webHook: {
		port: config.logistuzbot.port,
		autoOpen: false
	}
})
...
const welcomeMessage = '<b>Добро пожаловать в Profimed.uz!</b>\nВыберите нужный раздел:\n👇'
const formHeader = '<b>Добавление нового клиента</b>\nПожалуйста, заполните поля ниже\nЖирные пункты обязательны для заполнения\n👇\n\n'
const formFields = {
	/*'tovarname': {
		'langRU': 'Что перевезти?',
		'smile': '🛒',
		'inputMess': '<b>Введите наименование груза:</b>\n👇'
	},
	'tovartip': {
		'langRU': 'Тип груза',
		'smile': '📦',
		'inputMess': '<b>Выберите тип груза:</b>\n👇'
	},
	'tovarotkuda': {
		'langRU': 'Откуда?',
		'smile': '➡️',
		'inputMess': '<b>Введите откуда перевести груз:</b>\n👇'
	},
	'tovarkuda': {
		'langRU': 'Куда?',
		'smile': '⬅️',
		'inputMess': '<b>Введите куда перевести груз:</b>\n👇'
	},
	'tovarobyom': {
		'langRU': 'Объем, м³',
		'smile': '📐',
		'inputMess': '<b>Введите какой Объем груза, м³:</b>\n👇'
	},
	'tovarves': {
		'langRU': 'Вес, кг',
		'smile': '⚖️',
		'inputMess': '<b>Введите какой вес груза, кг:</b>\n👇'
	},*/
	'tovarimya': {
	...
	'tovarmobil': {
		'langRU': 'Мобильный телефон',
		'smile': '📞',
		'inputMess': '<b>Введите Мобильный телефон:</b>\n👇'
	},*/
}
const settFields = {
	'settingimya': {
...
sequelize.sync({ force: false })
	.then(() => {
		console.log(`Server started on port ${config.logistuzbot.port}`)
	})

bot.openWebHook()
bot.setWebHook(`${config.logistuzbot.url}/bot${TOKEN}`)
